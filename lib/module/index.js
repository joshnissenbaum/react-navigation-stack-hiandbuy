...
export const Assets = [require('./views/assets/back-icon.png'), require('./views/assets/back-icon-mask.png')];
/**
 * Views
 */
...
export { NavigationStackState, NavigationStackProp, NavigationStackOptions, NavigationStackConfig, NavigationStackScreenComponent, NavigationStackScreenProps, HeaderProps, HeaderBackButtonProps, HeaderTitleProps, TransitionPreset, CardStyleInterpolator, HeaderStyleInterpolator } from './types';
