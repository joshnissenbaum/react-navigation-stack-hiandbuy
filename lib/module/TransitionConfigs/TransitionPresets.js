import { forHorizontalIOS, forVerticalIOS, forRevealFromBottomAndroid, forFadeFromBottomAndroid, forModalPresentationIOS } from './CardStyleInterpolators';
import { forNoAnimation, forFade } from './HeaderStyleInterpolators';
import { TransitionIOSSpec, RevealFromBottomAndroidSpec, FadeOutToBottomAndroidSpec, FadeInFromBottomAndroidSpec } from './TransitionSpecs';
import { Platform } from 'react-native';
const ANDROID_VERSION_PIE = 28; // Standard iOS navigation transition
...
export const DefaultTransition = Platform.select({
  ...
  default: Platform.OS === 'android' && Platform.Version < ANDROID_VERSION_PIE ? FadeFromBottomAndroid : RevealFromBottomAndroid
});
