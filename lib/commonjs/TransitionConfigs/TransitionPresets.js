...
exports.ModalTransition = exports.DefaultTransition = exports.RevealFromBottomAndroid = exports.FadeFromBottomAndroid = exports.ModalPresentationIOS = exports.ModalSlideFromBottomIOS = exports.SlideFromRightIOS = void 0;
...
const DefaultTransition = _reactNative.Platform.select({
  ...
  default: _reactNative.Platform.OS === 'android' && _reactNative.Platform.Version < ANDROID_VERSION_PIE ? FadeFromBottomAndroid : RevealFromBottomAndroid
});
